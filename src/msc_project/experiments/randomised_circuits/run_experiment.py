...
run_experiment_with_target_dist(ExperimentSpecs("laplace", "experiment_laplace_small", num_samples=20, n=3, c=20, log_w=1, sample_size=sample_size, target_weights=target_weights, target_biases=target_biases))