...
class WeightSampler:
    ...
    def sample(self, num_samples: int, sign: Literal["positive", "negative"] = "positive") -> torch.Tensor:
...
class WeightBankSampler(WeightSampler):
    ...
    def __init__(self, target_distribution: torch.Tensor, num_positive_samples: int, num_negative_samples: int):
        self.target_distribution = target_distribution
