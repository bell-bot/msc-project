...
from msc_project.algorithms.genetic_algorithm.utils import GAConfig, GARunConfig, create_magnitude_aware_fitness_func, create_simple_fitness_func
...
ga_run_config = GARunConfig(
    ga_config=ga_config,
    num_experiments = 5,
    create_fitness_func = create_magnitude_aware_fitness_func,
    target_model_name="gpt2",
    experiment_name="magnitude_aware_fitness_func",
    run_start_idx = 5
)
