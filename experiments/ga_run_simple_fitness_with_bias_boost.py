...
from msc_project.algorithms.genetic_algorithm.utils import GAConfig, GARunConfig, create_simple_fitness_func
...
ga_run_config = GARunConfig(
    ...
    experiment_name="simple_fitness_with_bias_boost",
    factor_b=5.0
)
